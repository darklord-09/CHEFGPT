...
<div className="d-flex justify-content-center align-items-center vh-100"> {/* Center vertically and horizontally */}
      <div className="card" style={{ backgroundColor: '#D2691E', color: 'white' }}> {/* Chocolate color and white text */}
        <div className="card-body">
          <h1 className="card-title text-center" style={{color : 'white'}}>Sign In</h1> {/* Centered title */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-light" style={{marginRight:'30px'}}>Sign In</button> 
            <button  className="btn btn-dark" onClick={handleSignUp}>Sign Up</button>{/* Light button for contrast */}
            </div>
          </form>
        </div>
      </div>
